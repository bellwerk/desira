        ...
        <div>
          <div className="flex items-center gap-2 flex-wrap justify-center">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex h-11 items-center justify-center gap-1.5 rounded-xl bg-white/10 px-3 text-xs font-medium text-white transition-colors hover:bg-white/20 font-[family-name:var(--font-urbanist)]"
            >
