...
export function EmptyListState({
  ...
  const [isModalOpen, setIsModalOpen] = useState(Boolean(initialSuggestion));
  const [selectedIdea, setSelectedIdea] = useState<GiftIdea | null>(
    initialSuggestion ? { id: "suggestion", emoji: "", label: initialSuggestion } : null
  );
  ...
  return (
    <div className="mx-auto max-w-3xl pt-8 sm:pt-16 lg:pt-[140px]">
      ...
      <AddWishModal
        ...
        listId={listId}
        initialTitle={selectedIdea?.label ?? prefillSuggestion}
      />
    </div>
  );
}
